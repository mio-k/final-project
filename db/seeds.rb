...
mio = User.create(username: "miok", password: "password", firstname: "Mio", lastname: "Kataoka", pic:"./img/dray.jpg", contact:"510.356.8868")
aimee = User.create(username: "aimeek", password: "password", firstname: "Aimee", lastname: "Kalnoskas", pic:"./img/dray.jpg", contact:"510.356.8868")
molly = User.create(username: "mollyb", password: "password", firstname: "Molly", lastname: "Bergstrom", pic:"./img/dray.jpg", contact:"510.356.8868")
yui = User.create(username: "yuii", password: "password", firstname: "Yui", lastname: "Ikeda", pic:"./img/dray.jpg", contact:"510.356.8868")
fiona = User.create(username: "fionap", password: "password", firstname: "Fiona", lastname: "Peck", pic:"./img/dray.jpg", contact:"510.356.8868")
paul = User.create(username: "pauly", password: "password", firstname: "Paul", lastname: "Yen", pic:"./img/dray.jpg", contact:"510.356.8868")
louise = User.create(username: "louiser", password: "password", firstname: "Louise", lastname: "Rafkin", pic:"./img/dray.jpg", contact:"510.356.8868")
phyllis = User.create(username: "phyllisr", password: "password", firstname: "Phyllis", lastname: "Ritchie", pic:"./img/dray.jpg", contact:"510.356.8868")
